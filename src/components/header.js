...
export default function Header() {
  ...
  return (
    <nav
      className={cn(
        'z-50 sticky top-0 overflow-auto transition-all duration-300 ease-in-out bg-white border-b-2 border-primary-600',
      )}
    >
      <div className='px-5 py-5 font-bold leading-normal w-full flex flex-row gap-2 items-center justify-between'>
        <Link href={'/'}>
