      ...
      <Container>
        <div className='grid-cols-2 gap-8 content-center py-8 px-4 mx-auto max-w-screen-xl md:grid lg:py-16 lg:px-6'>
          <div className='self-center'>
            <h1 className='mb-4 text-2xl font-bold text-secondary-900'>{t('maintenance.title')}</h1>
            <p className='mb-4 text-3xl tracking-tight font-bold lg:mb-10 md:text-4xl text-secondary-900'>
